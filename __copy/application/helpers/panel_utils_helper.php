	...
	function panelshowTop($text) {
		...
		<div style="background:#003D4C; color: white; width: 100%;height:41px;margin-bottom: 20px">
			<div style="padding: 0 25px;font-family:tahoma,sans-serif;">
				...
				<div onclick="location.href=\'/index.php/Users/logout\'" onmouseover="this.style.color=\'#003D4C\';this.style.background=\'#fff\'" onmouseout="this.style.color=\'#fff\';this.style.background=\'#003D4C\'" style="padding: 5px;border:1px solid white; float:left;margin:5px 10px 0 30px;cursor:pointer" title="Wyloguj">Wyloguj</div>
				<!--
