...
if ( ! function_exists('divShadow'))
{
	...
	function divShadow($width, $height, $content, $padding=15) {
		...
		<div style="width:'.$width.'px; height:'.$height.'px;">
				...
				<div style="float:left;width:6px;height:6px;background:url(\'/img/sh_left_top.png\') top left no-repeat"></div>
				<div style="float:left;width:'.$inWidth.'px;height:6px;background:url(\'/img/sh_top.png\') repeat-x"></div>
				<div style="float:left;width:6px;height:6px;background:url(\'/img/sh_right_top.png\') top left no-repeat"></div>
				...
				<div style="clear:both"></div>
				<div style="float:left;width:6px;height:6px;background:url(\'/img/sh_left_bottom.png\') top left no-repeat"></div>
				<div style="float:left;width:'.$inWidth.'px;height:6px;background:url(\'/img/sh_bottom.png\') repeat-x"></div>
				<div style="float:left;width:6px;height:6px;background:url(\'/img/sh_right_bottom.png\') top left no-repeat"></div>
