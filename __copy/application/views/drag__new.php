		...
		<table border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td width="658" valign="top">
					...
					<div style="margin: 25px 0 0 25px;background: url('/img/shadow_top.png') repeat-x; width:658px; height: 9px; " ></div>		
					<div style="margin: 0 0 0 25px; width: 658px; height: 548px; background: white;border:1px solid #67806e">
					...
					<div style="margin: 0 0 0 25px;background: url('/img/shadow.png') repeat-x; width:658px; height: 9px; " ></div>		
				</td>
					<td width="9" valign="top">
					<!-- 
						<div style="margin: 25px 0 0 0;background: url('/img/shadow_right557.png') left top no-repeat; width:7px; height: 557px;"></div>
					 -->
						<div style="margin: 35px 0 0 0;background: url('/img/shadow_right.png') repeat-y; width:9px; height: 548px;"></div>
				</td>
			</tr>
		</table>		
					...
					<div id="list-items"
						...
						foreach ($items as $filename) {
							...
							<div class="draggable" title="Przeciagnij obrazek na zdjecie obok"
								...
								<img id="prod3" src="/uploads/tmp/'.$filename.'" style="max-width:150px;max-height:200px">
							</div>
							';
						}//foreach
