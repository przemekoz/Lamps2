...
class Slupy extends CI_Controller {
	...
	public function __construct() {
		...
		$this->msg = array(
             'insert_success'   => 'Słup został dodany'
             ,'edit_success'     => 'Słup został zmieniony'
             ,'delete_success'   => 'Słup został usunięty'
             );
	...
	public function index() {
		...
		$data['list'] = $this->db->get('column');

		$data['msg'] = $this->input->get('msg');// isset($_GET['msg']) ? $this->msg[$_GET['msg']] : '';
