...
<div style="z-index:0; width:1012px; height:920px; margin:0 auto; position:relative; text-align:left">
	...
	<div style="position:relative; z-index:2; float:left; margin-top:33px; width:774px; height:148px;">
		
		<div style=" width:750px; height:30px;position:relative; left: 10px; top:28px ">
		
		<table border="0" cellpadding="0" cellspacing="0"><tr>
			<td valign="top"><div class="fb-like" data-href="http://www.promar-sj.com.pl/konfigurator.php" data-send="false" data-layout="button_count" data-width="120" data-show-faces="false" data-font="arial"></div></td>
			<td valign="top"><a href="https://twitter.com/share" class="twitter-share-button" data-url="http://www.promar-sj.com.pl/konfigurator.php" data-text="Zajrzyj na tę stronę" data-lang="pl" data-size="small">Tweet</a></td>
		</tr></table>
			
		</div>
	
		<div style="position:relative; z-index:2; float:left; margin-top:22px; width:774px; height:95px; background: url('/img/toolbar3.png') no-repeat;">
			
			<div style="margin-left:35px" onclick="window.open('/index.php/EmailsTemplate/preview', '_blank')" class="btn_out2" title="Podgląd">
...
<div style="float:left;text-align: center">
		...
		<div style="top:15px; float:left;background:#555;position:relative; left:30px;color:white;width:120px">
			<?php showButton('Wybierz tło', "location.href='/index.php/EmailsTemplate/choose_background'", 'grey'); ?>
		</div>
		<div style="top:15px;float:right;background:#555; position:relative; color:white;width:120px;margin-right:30px">
			<?php showButton('Dodaj element', "if('".$bgid."' == '0'){alert('Proszę najpierw wybrać tło.')}else{wnd=window.open('/index.php/EmailsTemplate/choose_item?bg=".$bgid."')}", 'grey') ?>
		</div>
		<div style="clear:both"></div>
